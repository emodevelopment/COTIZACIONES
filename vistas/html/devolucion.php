												...
												<div class="editar_factura" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->
													<form role="form" id="datos_factura">
														...
														<div class="form-group row">
															...
															<div class="col-12">
																<div class="input-group">
																	<input type="text" id="nombre_cliente" class="form-control" required value="<?php echo $nombre_cliente; ?>" tabindex="2" disabled="true" style=" background-color:#D4E6F1; border-radius: 5px; border: 1px solid #39c;" >
														...
														<div class="col-md-12" align="center">
															<button type="button" id="imprimir2" class="btn btn-default  btn-block btn-lg waves-effect waves-light" onclick="printFactura('<?php echo $id_factura; ?>');" accesskey="p"><span class="fa fa-print"></span> Imprimir</button>
																<!--<button type="button" class="btn btn-danger btn-block btn-lg waves-effect waves-light" id="btn_guardar"><span class="ti-shopping-cart-full"></span> Procesar</button>-->
														</div>
													</form>
