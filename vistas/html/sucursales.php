...
if ($permisos_editar == 1) {
        ...
        include "../modal/eliminar_sucursal.php";
    }
    ?>
									...
									<div class="form-group row">
										<div class="col-md-6">
											...
											<div class="col-md-3">
												...
												<button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#nuevaSucursal"><i class="fa fa-plus"></i> Nueva</button>
												</div>
