...
if ($permisos_editar == 1) {
        include '../modal/registro_impuesto.php';
        include "../modal/editar_impuesto.php";
        include "../modal/eliminar_impuesto.php";
    }
    ?>
									...
									<div class="form-group row">
										<div class="col-md-6">
											...
											<div class="col-md-3">
												...
												<button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#nuevoImp"><i class="fa fa-plus"></i> Agregar</button>
												</div>
