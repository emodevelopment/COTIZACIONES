...
include "../modal/eliminar_factura.php";
    ...
    ?>
								...
								<form class="form-horizontal" role="form" id="datos_cotizacion">
									...
									<div class='resultados_ajaxc'></div><!-- Carga los datos ajax -->
...
<script>
		function obtener_cobros(id_factura) {
			$(".outer_cobros").load("../modal/cobros.php?id_factura=" + id_factura);
		}
	</script>
