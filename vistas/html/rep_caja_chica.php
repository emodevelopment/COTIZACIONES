								...
								<div class="portlet-body">
									...
									<form class="form-horizontal" role="form" id="datos_cotizacion">
										...
										<div class="form-group row">
											...
											<div class="col-xs-3">
												<div class="input-group">
													<select id="tipo_caja" name="tipo_caja" class="form-control" onchange="load(1);">
...
$('.daterange').daterangepicker({
    ...
    var parametros = {"action":"ajax","page":page,'range':range,'tipo_caja':tipo_caja};
    $("#loader").fadeIn('slow');
    $.ajax({
      url:'../ajax/rep_caja_chica.php',
      data: parametros,
...
<script>
  function reporte(){
    ...
    VentanaCentrada('../pdf/documentos/rep_caja_chica.php?daterange='+daterange+"&tipo_caja="+tipo_caja,'Reporte','','800','600','true');
  }
</script>
