...
if ($permisos_editar == 1) {
        include '../modal/registro_contratista.php';
        include "../modal/editar_contratista.php";
        include "../modal/eliminar_contratista.php";
    }
    ?>
									...
									<div class="form-group row">
										<div class="col-md-4">
											<div class="input-group">
												<input type="text" class="form-control" id="q" placeholder="Buscar por Nombre" onkeyup='load(1);' autocomplete="off">
											...
											<div class="col-md-2">
												...
												<button type="button" class="btn btn-success btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#nuevoContra"><i class="fa fa-user-plus"></i> Agregar</button>
												</div>
...
?>
	...
	<script type="text/javascript" src="../../js/contratistas.js"></script>
<script>
