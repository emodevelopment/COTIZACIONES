...
if ($permisos_editar == 1) {
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="q"
                                                    placeholder="Código o Nombre" onkeyup='load(1);'>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="input-group">
    ...
    while ($rw = mysqli_fetch_array($query_categoria)) {
        ?>
                                                    <option value="<?php echo $rw['id_linea']; ?>">
                                                        <?php echo $rw['nombre_linea']; ?></option>
                                                    <?php
}
    ?>
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="btn-group pull-right">
                                                <button type="button"
                                                    ...
                                                    data-toggle="modal" data-target="#nuevoProducto"><i
                                                        class="fa fa-plus"></i> Crear Producto</button>
                                            </div>
                                            ...
                                            <div class="btn-group pull-left">
                                                ...
                                                <div class="btn-group dropup">
                                                    <button aria-expanded="false"
                                                        class="btn btn-outline-default btn-rounded waves-effect waves-light"
...
function reporte() {
    ...
    VentanaCentrada('../pdf/documentos/rep_productos.php?daterange=' + daterange + "&categoria=" + categoria, 'Reporte',
        '', '800', '600', 'true');
}
</script>
<script>
