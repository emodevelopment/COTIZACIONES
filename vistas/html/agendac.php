...
if ($permisos_editar == 1) {
        include '../modal/registro_agente.php';
        include "../modal/editar_agente.php";
        include "../modal/eliminar_agente.php";
    }
    ?>
									...
									<div class="form-group row">
										<div class="col-md-4">
											...
											<div class="col-md-2">
												...
												<button type="button" class="btn btn-success btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#nuevoAgente"><i class="fa fa-user-plus"></i> Agregar</button>
												</div>
...
?>
	...
	<script type="text/javascript" src="../../js/agentes.js"></script>
<script>
