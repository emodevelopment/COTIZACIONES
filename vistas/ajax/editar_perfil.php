...
if (empty($_POST['nombre_empresa'])) {
    ...
    $precio_venta   = intval($_POST['pv']);
    $doc_cliente    = mysqli_real_escape_string($conexion, (strip_tags($_POST["doc_cliente"], ENT_QUOTES)));
    $doc_proveedor  = mysqli_real_escape_string($conexion, (strip_tags($_POST["doc_proveedor"], ENT_QUOTES)));
