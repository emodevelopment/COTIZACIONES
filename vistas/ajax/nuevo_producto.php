...
if (empty($_POST['codigo'])) {
    ...
    $precio_proyecto  = floatval($_POST['preciop']);
...
// check if user or email address already exists
    ...
    if ($query_check_user == true) {
        $sql = "UPDATE productos SET codigo_producto='" . $codigo . "',
                                        ...
                                        valor4_proyecto='" . $precio_proyecto . "',
                                        stock_producto='" . $stock . "',
                                        stock_min_producto='" . $stock_minimo . "'
                                        WHERE codigo_producto='" . $codigo . "'";
        $query_update = mysqli_query($conexion, $sql);
    } else {
        $sql              = "INSERT INTO productos (codigo_producto, nombre_producto, descripcion_producto, id_linea_producto, id_proveedor, inv_producto, iva_producto, estado_producto, costo_producto, utilidad_producto, valor1_producto,valor2_producto,valor3_producto, valor4_producto, stock_producto,stock_min_producto, date_added,id_imp_producto) VALUES ('$codigo','$nombre','$descripcion','$linea','$proveedor','$inv','$impuesto','$estado','$costo','$utilidad','$precio_venta','$precio_mayoreo','$precio_especial','$precio_proyecto','$stock','$stock_minimo','$date_added','0')";
