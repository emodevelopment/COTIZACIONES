...
while ($row = mysqli_fetch_array($sql)) {
    ...
    <tr>
        ...
        <td class='text-center' width="15%">
            <input style=" background-color:#A9DFBF; border-radius: 5px; border: 1px solid #39c; text-align: center" type="text" class="form-control txt_cant" value="<?php echo $cantidad; ?>" id="<?php echo $id_detalle; ?>">
        </td>
        <td><?php echo $nombre_producto; ?></td>
        <td class='text-center'>
            <div class="input-group">
                <select id="<?php echo $id_detalle; ?>" class="form-control employee_id" <?php echo $ok; ?>>
                    <?php
$sql1 = mysqli_query($conexion, "select * from productos where id_producto='" . $id_producto . "'");
    ...
    ?>
        ...
        <td align="right" width="15%">
                <input style=" background-color:#F7DC6F; border-radius: 5px; border: 1px solid #39c; text-align: center;" type="text" class="form-control txt_desc" value="<?php echo $desc_tmp; ?>" id="<?php echo $id_detalle; ?>">
        </td>
