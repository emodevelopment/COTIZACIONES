...
if (empty($_POST['abono'])) {
    ...
    $sql = "INSERT INTO creditos_abonos (numero_factura, fecha_abono, id_cliente, monto_abono, abono, saldo_abono, id_users_abono, id_sucursal, concepto_abono)
  VALUES ('$numero_factura', '$fecha', '$id_cliente', '$monto_credito', '$abono', '$saldo', '$user_id','1','$concepto');";
    ...
    $update_saldo = mysqli_query($conexion, "update creditos set saldo_credito='" . $saldo . "' where numero_factura='$numero_factura'");
