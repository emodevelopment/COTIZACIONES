...
if (empty($_POST['mod_id'])) {
    ...
    $email       = mysqli_real_escape_string($conexion, (strip_tags($_POST["email2"], ENT_QUOTES)));
    ...
    $sql       = "UPDATE agentes SET nom_agente='" . $nombre . "',
                                        tel1_agente='" . $tel1 . "',
                                        tel2_agente='" . $tel2 . "',
                                        email_agente='" . $email . "',
                                        fiscal_agente='" . $comprobante . "',
                                        banco_agente='" . $banco . "',
                                        cuenta_agente='" . $cuenta . "',
                                        esp_agente='" . $esp . "',
                                        estado_agente='" . $estado . "'
                                        WHERE id_agente='" . $id_contra . "'";
    $query_update = mysqli_query($conexion, $sql);
    if ($query_update) {
        $messages[] = "Agente ha sido actualizado con Exito.";
    } else {
