...
$sql1 = mysqli_query($conexion, "select * from productos where id_producto='" . $id_producto . "'");
    ...
    ?>
        ...
        <td align="right" width="15%">
               <input type="text" class="form-control txt_desc"  style=" background-color:#F7DC6F; border-radius: 5px; border: 1px solid #39c; text-align: center;" value="<?php echo $desc_tmp; ?>" id="<?php echo $id_detalle; ?>">
        </td>
