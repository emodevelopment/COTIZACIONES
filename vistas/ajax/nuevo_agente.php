...
if (empty($_POST['nombre'])) {
    ...
    if ($query_check_user == true) {
        ...
        $sql              = "INSERT INTO agentes (nom_agente, tel1_agente, tel2_agente, email_agente, fiscal_agente, banco_agente,cuenta_agente, esp_agente, estado_agente, date_addeda) VALUES ('$nombre','$tel1','$tel2','$email','$comprobante','$banco','$cuenta','$esp','$estado','$date_added')";
        $query_new_insert = mysqli_query($conexion, $sql);
        if ($query_new_insert) {
            $messages[] = "Agente ha sido ingresado con Exito.";
        } else {
