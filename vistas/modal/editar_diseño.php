...
if (isset($conexion)) {
    ?>
	<div id="editarDiseño" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					<h4 class="modal-title"><i class='fa fa-edit'></i> Editar Diseño</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" method="post" id="editar_diseño" name="editar_diseño">
