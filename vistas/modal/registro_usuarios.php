						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="user_name" name="user_name" pattern="[a-zA-Z0-9\-.]{2,64}" title="Nombre de usuario ( sólo letras y números, 2-64 caracteres y los caracteres - .)"required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
