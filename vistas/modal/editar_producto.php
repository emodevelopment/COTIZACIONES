								...
								<!--<div class="col-md-5">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="mod_costo" name="mod_costo" autocomplete="off" onkeyup="this.value=Numeros2(this.value)" title="Ingresa sólo números con 0 ó 2 decimales" required>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
