...
/*Fin datos empresa*/
$sql_factura    = mysqli_query($conexion, "select * from facturas_ventas, users where facturas_ventas.id_vendedor=users.id_users and facturas_ventas.id_factura='" . $factura_id . "'");
    ...
    <table width="175px" style="font-size:12px; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif" border="0" >
        <tr>
            <td colspan="3">
                ...
                <div align="center" style="font-size:16px"><strong>RUC: <?php echo $fiscal; ?></strong><br></div>
