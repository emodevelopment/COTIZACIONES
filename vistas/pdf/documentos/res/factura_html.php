...
$nums          = 1;
$sumador_total = 0;
$sql           = mysqli_query($conexion, "select * from productos, tmp where productos.id_producto=tmp.id_producto and tmp.session_id='" . $session_id . "'");
...
//Insert en la tabla detalle_factura
    $insert_detail = mysqli_query($conexion, "INSERT INTO detalle_factura VALUES ('','$id_factura','$numero_factura','$id_producto','$cantidad','$precio_venta_r')");
...
$insert = mysqli_query($conexion, "INSERT INTO facturas VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','1','$users')");
$delete = mysqli_query($conexion, "DELETE FROM tmp WHERE session_id='" . $session_id . "'");
?>