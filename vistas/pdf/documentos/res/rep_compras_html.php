...
<page pageset='new' backtop='10mm' backbottom='10mm' backleft='20mm' backright='20mm' style="font-size: 13px; font-family: helvetica">
  ...
  <table style="width: 100%; border: solid 0px black;" cellspacing=0>
    <tr>
      ...
      <td style="text-align: center;    width: 34%;font-size: 14px; font-weight: bold">Reporte de Compras</td>
  ...
  <div>
    ...
    <?php
$sql1           = mysqli_query($conexion, "select estado_factura from facturas_compras where estado_factura='" . $estado_factura . "'");
