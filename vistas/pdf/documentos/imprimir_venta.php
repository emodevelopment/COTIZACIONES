...
/*Fin datos empresa*/
$sql_factura    = mysqli_query($conexion, "select * from facturas_ventas INNER JOIN clientes ON clientes.id_cliente = facturas_ventas.id_cliente, users where facturas_ventas.id_vendedor=users.id_users and facturas_ventas.id_factura='" . $factura_id . "'");
...
<page pageset='new' backtop='10mm' backbottom='10mm' backleft='20mm' backright='20mm' footer='page'>
    <table width="175px" style="font-size:12px; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif" border="0" >
        <tr>
            <td colspan="3">
                <div class"img">
    				 <center> <img style="width: 100%;" align="center" src="../<?php echo $logo_url; ?>" alt="Logo"></center><br>
                </div>
    		</td>
    	</tr>
        <tr>
            <td colspan="3">
                ...
                <div align="center" style="font-size:14px"><strong><?php echo $city . ' ' . $state; ?></strong></div>
        ...
        <tr>
            <td colspan="3">
                ...
                <div align="left">Teléfono: <?php echo $telefono_cliente; ?></div>
                <div align="left">Dirección: <?php echo $direccion_cliente; ?></div>
            </td>
        </tr>
        <tr>
        </tr>
