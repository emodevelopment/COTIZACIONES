...
if ($login->isUserLoggedIn() == true) {
    ...
    header("location: vistas/html/new_cotizacion.php");
    ...
    <body>
        ...
        <div class="portlet">
            <div class="portlet-heading bg-dark" style="background: #2C3E50">
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="usuario_users" required="" placeholder="Asesor" autocomplete="off" autofocus="">
                            </div>
                        </div>
                    </div>
...
<br>
                    <div class="form-group text-right m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-lg btn-dark waves-effect waves-light btn-block btn-signin" type="submit" name="login" id="submit"><i class='fa fa-unlock'></i> Iniciar Sesión
                            </button>
                        </div>
                    </div>
                </form>
